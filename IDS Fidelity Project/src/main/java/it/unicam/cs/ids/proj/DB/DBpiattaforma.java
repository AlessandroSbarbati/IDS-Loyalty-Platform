...
public class DBpiattaforma {
    ...
    private final static String INSERT = "INSERT INTO proprietari " +
            "(nome) (cognome) (dataNascita) (residenza) (telefono) (email) (nomeUtente) (password)(partitaIVA) +" +
            " values (?)(?)(?)(?)(?)(?)(?)(?)(?)";
    private final static String SELECT = "SELECT * from proprietari";
